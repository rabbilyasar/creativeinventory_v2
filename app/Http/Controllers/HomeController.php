...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home', compact('company_count', 'supplier_count', 'warehouse_count', 'user_count', 'product_count', 'TestChart', 'requisitions', 'requisition_by_id', 'purchase_count', 'requisition_count'));
    }
    ...
    public function reject($requisition){
        ...
        return redirect('/')->withStatus('You have rejected the request');
    ...
    public function forward($requisition){
        ...
        return redirect('/')->withStatus('You have forwarded the request to super admin');
    }
}
